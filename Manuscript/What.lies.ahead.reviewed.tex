...
Given such heterogeneity in projections, gains and losses tend to balance one another out when looking at richness variation within phyla; we find no change in median richness for the year 2095 relative to the present in the Hood Canal(ANOVA; taxon richness  by year, p $=$ 0.7). Diatoms, however, show consistent and significant declines in richness in both Areas (Wilcoxon p $< 10^{-16}$). 
